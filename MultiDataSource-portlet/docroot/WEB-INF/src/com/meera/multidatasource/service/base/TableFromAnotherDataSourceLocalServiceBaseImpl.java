...
/**
 * The base implementation of the table from another data source local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.meera.multidatasource.service.impl.TableFromAnotherDataSourceLocalServiceImpl}.
 * </p>
 *
 * @author E5410
 ...
 * @generated
 */
public abstract class TableFromAnotherDataSourceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements TableFromAnotherDataSourceLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.meera.multidatasource.service.TableFromAnotherDataSourceLocalServiceUtil} to access the table from another data source local service.
	 */
	...
	public TableFromAnotherDataSource addTableFromAnotherDataSource(
		TableFromAnotherDataSource tableFromAnotherDataSource)
		throws SystemException {
		tableFromAnotherDataSource.setNew(true);

		return tableFromAnotherDataSourcePersistence.update(tableFromAnotherDataSource,
			false);
	}
	 ...
	 */
	public TableFromAnotherDataSource createTableFromAnotherDataSource(
		long IFADSId) {
		return tableFromAnotherDataSourcePersistence.create(IFADSId);
	}
	...
	public TableFromAnotherDataSource deleteTableFromAnotherDataSource(
		long IFADSId) throws PortalException, SystemException {
		return tableFromAnotherDataSourcePersistence.remove(IFADSId);
	}
	...
	public TableFromAnotherDataSource deleteTableFromAnotherDataSource(
		TableFromAnotherDataSource tableFromAnotherDataSource)
		throws SystemException {
		return tableFromAnotherDataSourcePersistence.remove(tableFromAnotherDataSource);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(TableFromAnotherDataSource.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tableFromAnotherDataSourcePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tableFromAnotherDataSourcePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TableFromAnotherDataSource fetchTableFromAnotherDataSource(
		long IFADSId) throws SystemException {
		return tableFromAnotherDataSourcePersistence.fetchByPrimaryKey(IFADSId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TableFromAnotherDataSource getTableFromAnotherDataSource(
		long IFADSId) throws PortalException, SystemException {
		return tableFromAnotherDataSourcePersistence.findByPrimaryKey(IFADSId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tableFromAnotherDataSourcePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TableFromAnotherDataSource> getTableFromAnotherDataSources(
		int start, int end) throws SystemException {
		return tableFromAnotherDataSourcePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTableFromAnotherDataSourcesCount() throws SystemException {
		return tableFromAnotherDataSourcePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TableFromAnotherDataSource updateTableFromAnotherDataSource(
		TableFromAnotherDataSource tableFromAnotherDataSource)
		throws SystemException {
		return updateTableFromAnotherDataSource(tableFromAnotherDataSource, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.meera.multidatasource.model.TableFromAnotherDataSource",
			tableFromAnotherDataSourceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tableFromAnotherDataSourcePersistence.getDataSource();
	...
	private TableFromAnotherDataSourceLocalServiceClpInvoker _clpInvoker = new TableFromAnotherDataSourceLocalServiceClpInvoker();
}